...
import com.catchebstnew.www.callback.OnWheelClickedListener;
import com.catchebstnew.www.callback.OnWheelScrollListener;
import com.catchebstnew.www.callback.WheelViewAdapter;
...
//			0xffffff, 0xffffff };
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		itemsLayout.measure(MeasureSpec.makeMeasureSpec(width - 3 * PADDING, MeasureSpec.EXACTLY),
				MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
	...
	private void layout(int width, int height) {
		int itemsWidth = width - 3 * PADDING;
...
//			if(context instanceof CourierSelectTimeActivity) {
//
//				drawCenterRect(canvas);
//			}
		}
	...
	private void drawShadows(Canvas canvas) {
		...
		//*/
		int height = (int)(SHADOWS_COUNT * getItemHeight());
		//*/
...
//		// 绘制下边直线
		canvas.drawLine(0, center + offset, getWidth(), center + offset, paint);
//		//*/
//		Rect rect = new Rect(0,center - offset,getWidth(), center + offset);
//		RectF rectF = new RectF(0,center - offset,getWidth(), center + offset);
//		Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(),R.mipmap.time_bg);
//		canvas.drawBitmap(bitmap,rect,rectF,paint);
	...
	public void setSHADOWS_COUNT(int count){
		this.SHADOWS_COUNT = count;
	}
}
